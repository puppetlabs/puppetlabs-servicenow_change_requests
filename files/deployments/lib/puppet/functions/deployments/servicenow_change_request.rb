...
Puppet::Functions.create_function(:'deployments::servicenow_change_request') do
  ...
  def servicenow_change_request(endpoint, proxy, username, password, oauth_token, report, ia_url, promote_to_stage_name, promote_to_stage_id, assignment_group, connection_alias, auto_create_ci, attach_ia_csv, ia_csv_export)
    ...
    if attach_ia_csv and ! ia_csv_export.empty?
